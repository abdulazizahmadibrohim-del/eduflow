...
export default function DashboardScreen() {
  ...
  const { user, students, courses, groups, payments, updatePayment } = useApp();
  ...
  const stats = useMemo(() => {
    ...
    return { activeStudents, paidAmount, overdueCount, courseCount: courses.length };
  }, [students, payments, courses, currentMonth]);
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={[
        styles.content,
        { paddingTop: topPadding + 16, paddingBottom: isWeb ? 34 + 80 : 80 }
      ]}
    ...
    >
      ...
      <View style={[styles.revenueBanner, { backgroundColor: colors.primary }]}>
        <View>
          <Text style={[styles.revenueLabel, { fontFamily: "Inter_400Regular" }]}>
            Bu oylik daromad
          </Text>
